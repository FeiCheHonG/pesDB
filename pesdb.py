...
for i in range(len(players_urlid)):
	other_info = gi.getplayerinfo(players_urlid[i][2:], players_name[i], data_name, level_datas)
	db_o.insert_baseinfo(cur, players_num[i], players_urlid[i], players_name[i], other_info)
